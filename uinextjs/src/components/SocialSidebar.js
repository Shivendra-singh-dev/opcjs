  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: "📘",
      url: "https://facebook.com/OracalPoint/",
      color: "#1877f2",
      hoverColor: "#145dbf",
    },
    {
      name: "Instagram",
      icon: "📸",
      url: "https://instagram.com/oracalpoint",
      color: "#e4405f",
      hoverColor: "#c13584",
    },
    {
      name: "YouTube",
      icon: "▶️",
      url: "https://youtube.com/oracalpoint",
      color: "#ff0000",
      hoverColor: "#cc0000",
    },
    {
      name: "Twitter",
      icon: "🐦",
      url: "https://twitter.com/oracalpoint",
      color: "#1da1f2",
      hoverColor: "#0d8bd9",
    },
    {
      name: "LinkedIn",
      icon: "🔗",
      url: "https://linkedin.com/in/oracalpoint",
      color: "#0a66c2",
      hoverColor: "#004182",
    },
    // {
    //   name: "GitHub",
    //   icon: "💻",
    //   url: "https://github.com/oracalpoint",
    //   color: "#333",
    //   hoverColor: "#000",
    // },
    {
      name: "Pinterest",
      icon: "📌",
      url: "https://pinterest.com/oracalpoint",
      color: "#e60023",
      hoverColor: "#bd081c",
    },
    {
      name: "TikTok",
      icon: "🎵",
      url: "https://tiktok.com/@oracalpoint",
      color: "#000",
      hoverColor: "#fe2c55",
    },
  ];
